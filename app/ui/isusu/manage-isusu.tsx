  ...
  return (
    <div className="p-4 bg-gray-100 h-screen">
      ...
      <div className="flex justify-end items-center space-x-4 w-full">
        <button type="button" className="flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg space-x-2">
          <PlusIcon className="w-6" />
          <span>Create Isusu</span>
        </button>
        <button type="button" className="flex items-center bg-green-600 text-white px-6 py-3 rounded-lg space-x-2">
      ...
      <div className="flex flex-col items-center mt-8 bg-gray-200 w-[40%] p-6 rounded-lg shadow-lg mx-auto">
        ...
        <div className="flex items-center space-x-2 w-full mb-4">
          <p className="text-left text-xl font-bold text-blue-600 flex-1">Ohamazi Cooperative</p>
